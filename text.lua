...
local Window = ReGui:TabsWindow({
	Title = "[🍬] CandyHub Rework - ".. name .. " " .. scriptversion,
	...
	Callback = function(self, v: boolean)
        task.spawn(function()
            ...
            while _G.candyhub.autodust and task.wait() do
                game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("GachaEvents"):WaitForChild("Spin"):InvokeServer()
                game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("GachaEvents"):WaitForChild("Test"):InvokeServer()
            end
        end)
	end
})
